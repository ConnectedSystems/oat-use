...
samples = sample(problem, 5, seed=101, calc_second_order=False)
...
numeric_df.to_csv(indir+'saltelli_5_numeric_samples.csv')
...
saltelli_df[df_samples.columns] = df_samples
saltelli_df = saltelli_df.rename('{}_saltelli_5_sample'.format)
saltelli_df.to_csv(indir+'saltelli_5_samples.csv')
